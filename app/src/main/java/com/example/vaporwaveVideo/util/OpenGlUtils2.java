...
import com.example.vaporwaveVideo.filter.GPUImageFilter;
...
public class OpenGlUtils2 {
	...
	public static String readShaderFromRawResource(final int resourceId){
		final InputStream inputStream = getContext().getResources().openRawResource(
				resourceId);
    ...
    public static Bitmap drawToBitmapByFilter(Bitmap bitmap, GPUImageFilter filter,
        ...
        int textureId = OpenGlUtils2.loadTexture(bitmap, OpenGlUtils2.NO_TEXTURE, true);
        if(rotate){
