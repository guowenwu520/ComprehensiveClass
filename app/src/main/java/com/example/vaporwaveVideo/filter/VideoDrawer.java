...
public class VideoDrawer implements GLSurfaceView.Renderer {
    ...
    private ArrayList<WaterMarkFilter> waterMarkFilters=new ArrayList<>();
...
//        mShow.setMatrix(OM);
//        MatrixUtils.flip(mBeFilter.getMatrix(),false,true);
    ...
    public  void addLogo(WaterMarkFilter waterMarkFilter){
        mBeFilter.addFilter(waterMarkFilter);
        waterMarkFilters.add(waterMarkFilter);
    }
