...
public class MediaPlayerWrapper implements MediaPlayer.OnCompletionListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener {
    ...
    private MedioSizeChang medioSizeChang;
    ...
    public void setMedioSizeChang(MedioSizeChang medioSizeChang) {
        this.medioSizeChang = medioSizeChang;
    }

    @Override
    public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i1) {
        if(mediaPlayer!=null)
        medioSizeChang.onVideoSizeChanged(mediaPlayer,i,i1);
    }
...
//        switchPlayer(mp);
    ...
    public PlaybackParams getPlaybackParams() {
        return mCurMediaPlayer.getPlaybackParams();
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    public void setPlaybackParams(PlaybackParams params) {
        mCurMediaPlayer.setPlaybackParams(params);
    }

    public interface MedioSizeChang{
