...
public class MagicNashvilleFilter extends GPUImageFilter {
	...
	public MagicNashvilleFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils2.readShaderFromRawResource(R.raw.nashville));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils2.loadTexture(getContext(), "filter/nashvillemap.png");
		    }
	    });
	}
}
