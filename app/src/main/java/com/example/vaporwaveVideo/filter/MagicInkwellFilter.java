...
public class MagicInkwellFilter extends GPUImageFilter {
	...
	public MagicInkwellFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils2.readShaderFromRawResource(R.raw.inkwell));
	}
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils2.loadTexture(getContext(), "filter/inkwellmap.png");
		    }
	    });
	}
}
