...
public class MagicFreudFilter extends GPUImageFilter {
	...
	public MagicFreudFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils2.readShaderFromRawResource(R.raw.freud));
	}
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils2.loadTexture(getContext(), "filter/freud_rand.png");
		    }
	    });
	}
